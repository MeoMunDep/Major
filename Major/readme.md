...
> > > Help me with your referral [Link](https://t.me/major/start?startapp=6713068747)
...
```json
{
  "durovCombo": [1, 2, 3, 4], // place the "durovCombo" right, it has all 16 number, so choose it urself
